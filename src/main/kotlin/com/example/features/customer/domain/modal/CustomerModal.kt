...
data class adminAcess(
    ...
    var sellerId: String? = null,
    var isSuperAdmin: String? = null,
    var lat: String? = null,
    var lng: String? = null,
)

data class adminAvailable(
    var society_pincode: String? = null,
    var price: String? = null,
    val city: String?,
...
data class RelatedSerachByPriceAndCategory(
